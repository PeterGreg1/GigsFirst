CoolClock.config.skins = {
	...
	classic/*was gIG*/: {
	outerBorder: { lineWidth: 185, radius: 1, color: "#1ebbe2", alpha: 1 },
		smallIndicator:   { lineWidth: 2, startAt: 89, endAt: 94, color: "#FFFFFF", alpha: 1 },
		largeIndicator:   { lineWidth: 4, startAt: 83, endAt: 94, color: "#FFFFFF", alpha: 1 },
		...
		secondDecoration: { lineWidth: 3, startAt: 0, radius: 2, fillColor: "#1ebbe2", color: "white", alpha: 1 }
	},
